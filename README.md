...
- **内置词库**：中考1600、高考3500、初中2182、人教版/外研版/闽教版/仁爱版等 10 套教材，外加课标字表（基本字表 300 / 常用字表 2500 + 1000），共 406 份词表，支持按词表名或单词搜索；词表预览页可直接开始听写（同样支持随机顺序与起始序号），或一键载入草稿继续编辑。
...
4. **复习**：结束后在成绩卡点「复习错词」只重听错词；「导出错词」把错词复制成词表，粘贴回首页即可再练；首页「更多」菜单的错词本也能随时复习。
