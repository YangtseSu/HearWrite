...
private val HANZI = mapOf(
    ...
    '布' to ("bu" to 5), '步' to ("bu" to 7), '草' to ("cao" to 9), '出' to ("chu" to 5),
    '春' to ("chun" to 9), '从' to ("cong" to 4), '翠' to ("cui" to 14), '大' to ("da" to 3),
    '带' to ("dai" to 9), '到' to ("dao" to 8), '的' to ("de" to 8), '邓' to ("deng" to 4),
    '帝' to ("di" to 9), '冬' to ("dong" to 5), '恩' to ("en" to 10), '尔' to ("er" to 5),
    '夫' to ("fu" to 4), '冈' to ("gang" to 4), '鸽' to ("ge" to 11), '光' to ("guang" to 6),
    '归' to ("gui" to 5), '国' to ("guo" to 8), '海' to ("hai" to 10), '和' to ("he" to 8),
    '河' to ("he" to 8), '花' to ("hua" to 7), '怀' to ("huai" to 7), '皇' to ("huang" to 9),
    '黄' to ("huang" to 11), '回' to ("hui" to 6), '纪' to ("ji" to 6), '季' to ("ji" to 8),
    '济' to ("ji" to 9), '稼' to ("jia" to 15), '降' to ("jiang" to 8), '蛟' to ("jiao" to 12),
    '阶' to ("jie" to 6), '界' to ("jie" to 9), '井' to ("jing" to 4), '经' to ("jing" to 8),
    '睛' to ("jing" to 13), '可' to ("ke" to 5), '空' to ("kong" to 8), '来' to ("lai" to 7),
    '老' to ("lao" to 6), '梨' to ("li" to 11), '列' to ("lie" to 6), '岭' to ("ling" to 8),
    '龙' to ("long" to 5), '路' to ("lu" to 13), '萝' to ("luo" to 11), '猫' to ("mao" to 11),
    '梅' to ("mei" to 11), '命' to ("ming" to 8), '母' to ("mu" to 5), '南' to ("nan" to 9),
    '念' to ("nian" to 8), '女' to ("nu" to 3), '瀑' to ("pu" to 18), '亲' to ("qin" to 9),
    '青' to ("qing" to 8), '秋' to ("qiu" to 9), '求' to ("qiu" to 7), '日' to ("ri" to 4),
    '散' to ("san" to 12), '山' to ("shan" to 3), '谁' to ("shei" to 10), '圣' to ("sheng" to 5),
    '诗' to ("shi" to 8), '施' to ("shi" to 9), '事' to ("shi" to 8), '是' to ("shi" to 9),
    '誓' to ("shi" to 14), '首' to ("shou" to 9), '书' to ("shu" to 4), '说' to ("shuo" to 9),
    '斯' to ("si" to 12), '颂' to ("song" to 10), '塑' to ("su" to 13), '她' to ("ta" to 6),
    '台' to ("tai" to 5), '太' to ("tai" to 4), '泰' to ("tai" to 10), '藤' to ("teng" to 18),
    '天' to ("tian" to 4), '土' to ("tu" to 3), '托' to ("tuo" to 6), '娲' to ("wa" to 10),
    '往' to ("wang" to 8), '威' to ("wei" to 9), '为' to ("wei" to 4), '味' to ("wei" to 8),
    '我' to ("wo" to 7), '屋' to ("wu" to 9), '先' to ("xian" to 6), '新' to ("xin" to 13),
    '言' to ("yan" to 7), '眼' to ("yan" to 11), '雁' to ("yan" to 12), '依' to ("yi" to 8),
    '忆' to ("yi" to 4), '驿' to ("yi" to 8), '有' to ("you" to 6), '与' to ("yu" to 3),
    '雨' to ("yu" to 8), '寓' to ("yu" to 12), '再' to ("zai" to 6), '造' to ("zao" to 10),
